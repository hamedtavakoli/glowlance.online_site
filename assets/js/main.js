...
var LOCAL_PREVIEW_PARTIALS = {
  "partials/header.html": [
    ...
    '      <a class="brand" href="/" aria-label="VocabGlow home">',
    '        <img src="assets/images/vocabglow-logo.png" alt="VocabGlow logo" width="40" height="40">',
    '        <span>VocabGlow</span>',
    '      </a>',
  ...
  "partials/footer.html": [
    ...
    '      <a href="https://www.paypal.com/donate/?hosted_button_id=MTVGNXANCMYYC" target="_blank" rel="noopener noreferrer">Support the project</a>',
    '    </nav>',
    '  </div>',
    '</footer>'
  ].join("\n")
